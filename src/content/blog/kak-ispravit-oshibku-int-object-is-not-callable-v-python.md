...
meta_title: "Решение Python Ошибки: 'int object is not callable'"
description: "Подробное руководство по исправлению частой ошибки в Python 'TypeError: ‘int’ object is not callable'. Научитесь определять и избегать этой ошибки через реальные примеры и четкие объяснения, чтобы ваш код работал без сбоев."
...
tags:
  - Python
draft: false
lastmod: 2024-06-14T17:11:48.463Z
image: ../../assets/images/undefined-Jan-29-2023.avif
slug: kak-yspravyt-oshybku-int-object-is-not-callable-v-python
---
...
Все встроенные функции определяются в модуле builtins и получают глобальное имя для облегчения доступа. Например, sum() относится к функции **builtins**.sum().
...
2. Явно обратиться к функции sum() из модуля builtins (**bultins**.sum).
